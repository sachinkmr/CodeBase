...
public class Template {
    ...
    public static Template getInstance(String appPath) {
        if (template == null) {
            template = new Template(appPath);
        }
        return template;
    }

    private Template(String appPath) {
        try {
            templates = FileUtils.readLines(new File(appPath + "/WEB-INF/data/templates.txt"));
