 ...
 * @author sku202
 */
public class ContactUs implements Featurable {
...
//        driver = builder.getFirefoxDriver();
        ...
        if (driver.getPageSource().contains("recaptcha_response_field") || driver.getPageSource().contains("sc2powered")) {
            ...
            try {
                ...
                JSONObject data = HelperClass.readJsonFromFile(HelperClass.getDataFolderPath() + File.separator + "ContactUsData.json");
                ...
                if (site.isResponsive()) {
                    ...
                    try {
                        element = driver.findElement(By.className("ContactUsConfirm"));
                ...
                if (site.isMOS()) {
                    result.put("hasErrors", true);
                    errors.put("formError", "MOS site don't have contactus form");
                }
            } catch (Exception ex) {
                try {
                    Logger.getLogger(ContactUs.class.getName()).log(Level.SEVERE, null, ex);
                    ...
                    Logger.getLogger(ContactUs.class.getName()).log(Level.SEVERE, null, ex1);
                }
            }
        }
        try {
